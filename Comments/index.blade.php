...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-5">
        <h4>тут будет видео</h4>
      </div>
      <div class="col-md-7">
        <p class="lead">Материалы к мастер-классу</p>
        <p><h2>&laquo;Разработка планов и бюджетов компании на 2018 год&raquo;</h2></p>
      </div>
    </div>
    <div class="row text-center">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <p><h3>Чтобы получить дополнительные материалы, оставьте пожалуйста комментарий о компании iTeam</h3></p>
