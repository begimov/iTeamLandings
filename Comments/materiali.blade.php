...
<head>
  ...
  <meta property="og:description" content='Рекомендую бесплатный мастер-класс "Разработка стратегии шаг за шагом" консалтинговой компании iTeam'/>
    ...
    <div id="header" class="row">
      ...
      <div class="row text-center">
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              <p><h3>Пожалуйста, оставьте комментарий о компании iTeam</h3></p>
              <p><a href="#" class="modal2 btn btn-danger">ОСТАВИТЬ КОММЕНТАРИЙ</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <p><h1 class="display-4">Специальное предложение <small class="text-muted">до 27 сентября!</small></h1></p>
        </div>
      </div>
      <hr>
      <div class="row">
        <div class="col-md-4">
          <img src="/filemanager/userfiles/mkplanirovanieNEWW.png" width="80%;">
        </div>
        <div class="col-md-8">
          <div class="card">
            <div class="card-header">
              <h2>Как организовать планирование в компании от стратегического до оперативного уровня</h2>
            </div>
            <div class="card-body">

              <p class="lead">Мастер-класс для руководителей компаний и собственников бизнеса</p>
              <p><span><del>4000</del></span> <span style="font-size: 40px; color: darkred">2400 &#8381;</span></p>
              <p><a class="btn btn-danger btn-lg" href="https://iteam.ru/learn/webinar/effective_planning" target="_blank">Купить</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row text-center">
        <div class="col-md-12">
          <p>Если скачивание презентации не начинается, пожалуйста нажмите на кнопку</p>
          <h3><a href="Программа мастер-проекта Разработка планов и бюджетов 2018.pdf" class="btn btn-dark">Скачать презентацию</a></h3>
          <hr>
        </div>
      </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-left">
                <h4>Спасибо за интерес проявленный к нашим материалам!</h4>
                <p class="lead">Чтобы скачать презентацию, пожалуйста, оставьте отзыв:</p>
              </div>
            </div>
            <form id="forma" method="post" action="{{ route('emailTest.EmailSend.sendComm') }}" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <textarea class="form-control" name="commend" placeholder="Ваш отзыв*" required></textarea>
                  </div>
                </div>
              </div>
              <div class="row text-left">
                <div class="col-md-5 col-sm-5">
                  <div class="form-group">
                    <input class="form-control" type="text" name="userName" placeholder="ФИО*" value="" required>
                    <small class="form-text text-muted">Фамилия, имя и отчество</small>
                  </div>
                  <div class="form-group">
                    <input class="form-control" type="text" name="organization" placeholder="Организация*" value="" required>
                    <small class="form-text text-muted">Какую организацию вы представляете?</small>
                  </div>
                  <div class="form-group">
                    <label class="label">Ваше фото:</label>
                    <input class="form-control-file" type="file" name="image">
                  </div>
                  <input class="btn btn-dark" type="submit" name="sbmt">
                </div>
                <div class="col-md-7 col-sm-7">
                  <div class="card">
                    <div class="card-header">
                      <strong>Не знаете, что написать? Расскажите нам:</strong>
                    </div>
                    <div class="card-body">
                      <ul>
